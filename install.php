...
define('ASG_BASE_URL','http://{$instalar['servidor']}/tarea10');
";
...
file_put_contents("my_config.php",$my_config);
    ...
    $sql="DROP TABLE IF EXISTS `reportes`;";
    mysqli_query($link,$sql);  
  
$sql="CREATE TABLE `reportes` (
  `id` int(40) NOT NULL AUTO_INCREMENT,
  `fecha` date NOT NULL,
  `tipo` enum('hoyos','tapa de alcantarilla no presente','aguas estancadas') NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    echo "<script>
            ...
            window.location='http://{$instalar['servidor']}/tarea10/';
          </script>";
}
}
